...
async function runWheelRegionDetectorTests() {
  ...
  const isCentered1 =
    roi1 &&
    roi1.distanciaCentroModalParaCentroCrop === 0 &&
    Math.abs(roi1.absCropX + Math.round(roi1.absCropWidth / 2) - roi1.centerX) <= 1 &&
    Math.abs(roi1.absCropY + Math.round(roi1.absCropHeight / 2) - roi1.centerY) <= 1;
  ...
  const isCentered2 =
    roi2 &&
    roi2.distanciaCentroModalParaCentroCrop === 0 &&
    Math.abs(roi2.absCropX + Math.round(roi2.absCropWidth / 2) - roi2.centerX) <= 1 &&
    Math.abs(roi2.absCropY + Math.round(roi2.absCropHeight / 2) - roi2.centerY) <= 1;
  ...
  const isCentered3 =
    roi3 &&
    roi3.distanciaCentroModalParaCentroCrop === 0 &&
    Math.abs(roi3.absCropX + Math.round(roi3.absCropWidth / 2) - roi3.centerX) <= 1 &&
    Math.abs(roi3.absCropY + Math.round(roi3.absCropHeight / 2) - roi3.centerY) <= 1;
